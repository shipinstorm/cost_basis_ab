...
router.post("/cancel/:id", walletController.cancelWalletCostBasis);
router.post("/cancel/:id/:chain", walletController.cancelWalletCostBasis);
router.post("/cancel/:id/:chain/:protcol_id", walletController.cancelWalletCostBasis);
